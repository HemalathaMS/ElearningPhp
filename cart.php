            ...
            if (isset($_SESSION['email']))
             {
                 ...
                 $join_query="select * from user_items inner join items on user_id='$user_id' and status='Added to cart' and item_id=items.id";
                 ...
                 {?>
                   ...
                   while($row=mysqli_fetch_array($result))
                   {
                     ...
                     <tr>
                       ...
                       <?php echo "<td><a href='cart-remove.php?id=".$row['id']."'>Remove</a></td>"; ?>
                     </tr>
                   <?php } ?>
                     <tr>
